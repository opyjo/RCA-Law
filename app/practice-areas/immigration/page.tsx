      ...
      <section className="bg-gradient-to-b from-primary to-primary/90 text-primary-foreground py-16 md:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-4">
            <h1 className="text-4xl md:text-5xl font-serif font-bold text-white">Immigration Law</h1>
            <p className="text-xl text-white/90">Navigate Canada's immigration system with confidence</p>
          </div>
        </div>
      </section>
